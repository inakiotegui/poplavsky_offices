...
export default function ContactUs() {
  ...
  const isFormComplete =
    formData.fullName && formData.email && formData.message && isEmailValid;
      ...
      <div className="col-10 grid grid-nogutter nested-grid gap-3 mb-8">
        <section className="col-12 md:col-6 flex flex-column justify-content-between align-items-center">
          <div className="w-full px-4 md:px-6 grid grid-nogutter nested-grid justify-content-start align-items-center border-round">
            <p className="w-full flex gap-3 align-items-center text-white">
              ...
              C101, Business Bay. Dubai, UAE
            </p>
            <p className="w-full flex gap-3 align-items-center text-white">
              <i className="text-js-yellow pi pi-phone"></i>+971 585661300
            </p>
            <p className="w-full flex gap-3 align-items-center text-white">
              <i className="text-js-yellow pi pi-envelope"></i>
              patricio@poplavskydubaioffices.com
            </p>
            <p
              className="w-full flex gap-3 align-items-center text-white cursor-pointer"
              onClick={handleToInsta}
            >
        ...
        <section className="col-12 md:col border-round bg-trl-blue border-1 border-js-yellow">
          ...
          <form
            ...
            className="contact-form py-4 flex flex-column align-content-center"
          >

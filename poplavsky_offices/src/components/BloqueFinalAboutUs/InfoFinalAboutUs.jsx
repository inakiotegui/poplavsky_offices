...
export default function InfoFinalAboutUs() {
  return (
    <div className="grid grid-nogutter nested-grid flex-column md:flex-row p-2 gap-6 justify-content-center">
      <div className="col-12 md:col-5 p-2 md:p-4 h-auto md:h-18rem flex flex-column align-items-start justify-content-start text-white border-1 border-solid border-round border-bluegray-900">
        <div>

  ...
  return (
    <div className="NavBar grid grid-nogutter nested-grid h-5rem p-2 justify-content-between">
      ...
      <div className='col-5 bg-bluegray-400 border-round grid grid-nogutter justify-content-center align-items-center px-2 gap-4'>
        <Button label="Home" size='small' outlined onClick={() => navigate('/')} className='text-yellow-500 py-3 px-4' />
        <Button label="About Us" size='small' outlined onClick={() => navigate('/about-us')} className='text-yellow-500 py-3 px-4' />
        <Button label="Services" size='small' outlined onClick={() => navigate('/services')} className='text-yellow-500 py-3 px-4' />
      </div>

  ...
  return (
    <div className="Portada grid grid-nogutter nested-grid bg-bluegray-800 border-round gap-3 p-3 relative fadein animation-duration-1000 animation-iteration-1 animation-ease-in-out"
      ...
      <section className='bg-bluegray-400 border-round col-12 md:col-6 grid grid-nogutter nested-grid justify-content-center align-content-center align-items-center'>
        <div className='col-12 md:col-10 bg-bluegray-200 border-round p-3 grid grid-nogutter nested-grid justify-content-between fadeinleft animation-duration-1000 animation-iteration-1 animation-ease-in-out' style={{ minHeight: '25rem' }}>

          <div className='w-full'>
            <h1 className='m-0 text-3xl md:text-5xl w-full'>Somos tu puerta de acceso a Dubai</h1>
          ...
          <div className='col-12 grid grid-nogutter nested-grid justify-content-center align-content-end gap-6 mt-4 md:mt-0 '>
            ...
            <div className='col-12 grid grid-nogutter nested-grid gap-3 h-auto'>
              <div className='col border-round bg-bluegray-300 border-white border-1 grid grid-nogutter nested-grid px-3 py-2 shadow-2 ' style={{ height: 'fit-content' }}>
                <p className='m-0 col-12 font-semibold text-white text-3xl md:text-5xl'>200+</p>
                <span className='text-gray-500 text-xs font-light col-12'>Clientes Felices</span>
              </div>


              <div className='col border-round bg-bluegray-300 border-white border-1 grid grid-nogutter nested-grid px-3 py-2 shadow-2 ' style={{ height: 'fit-content' }}>
                <p className='m-0 col-12 font-semibold text-white text-3xl md:text-5xl'>10k+</p>
                <span className='text-gray-500 text-xs font-light col-12'>Servicios Aplicados</span>
              </div>

              <div className='col border-round bg-bluegray-300 border-white border-1 grid grid-nogutter nested-grid px-3 py-2 shadow-2 ' style={{ height: 'fit-content' }}>
                <p className='m-0 col-12 font-semibold text-white text-3xl md:text-5xl'>16+</p>
      ...
      <section className='bg-bluegray-400 border-round col grid grid-nogutter nested-grid justify-content-center align-content-center'>
        <div className='col-12 md:col-10 bg-bluegray-200 border-round p-3 grid grid-nogutter nested-grid align-content-start gap-3 fadeinright animation-duration-1000 animation-iteration-1 animation-ease-in-out' style={{ minHeight: '25rem' }}
        >

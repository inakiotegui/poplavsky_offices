...
const aboutus = [
  ...
  {
    imagen: imagen3,
    titulo: "Excellence and Personalized Attention for Every Client",
    texto1:
      "At Poplavsky International Offices DMCC, we prioritize excellence, confidentiality, and efficiency. Our team of highly skilled consultants is adept at handling even the most complex and non-standard challenges, ensuring that no matter the situation, you are in capable hands.",
    texto2:
      "Our approach is rooted in a commitment to quality and tailored service. We don’t believe in one-size-fits-all solutions; instead, we provide personalized strategies based on a detailed understanding of your specific business needs. Through clear communication and a focus on long-term relationships, we ensure a smooth and productive collaboration.",
  },
];
